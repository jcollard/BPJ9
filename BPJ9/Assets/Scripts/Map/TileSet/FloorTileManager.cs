...
{
    public FloorTile Model => this.GetComponent<FloorTile>();
...
[CustomEditor(typeof(FloorTileManager))]
public class FloorTileManagerEditor : Editor
{
    public override void OnInspectorGUI()
    {
        EditorGUI.BeginChangeCheck();
        FloorTileManager manager = (FloorTileManager)target;
        EditorGUILayout.ObjectField("Tile", manager.Model, typeof(FloorTile), false);
